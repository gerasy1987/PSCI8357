...
- Clearly comments what each line of code is doing
...
- Instructions:
    - Pair into groups of 3
    - Open the .r script in the GitHub folder and follow the instructions to produce (i) a regression table and (ii) visualization
...
7. Follow guidelines for formatting, we want our work to look nice!
