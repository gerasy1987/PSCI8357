...
*   - **1/26 1/28**
    ...
    - CEF and its properties, selection on observables, conditional ignorability, **problem set 1 is posted on 1/26**
...
*   - **2/4 2/9**
    ...
    - target quantities (SATE, PATE), inference for the SATE and PATE in an idealized experiment, randomization inference, imbalance, **problem set 2 is posted on 2/4**
...
*   - **2/18 2/23 2/25**
    - Matching
    - distance metrics, exact matching, nearest neighbor matching, propensity score matching, balancing property, sensitivity analysis, weighting, doubly robust estimators **problem set 3 is posted on 2/18**
...
*   - **3/2 3/4**
    ...
    - Local Average Treatment Effects, IV estimator, one-/two-sided non-compliance, 2SLS estimator and its bias, **problem set 4 is posted on 3/4**, **experimental replication is due on 3/2**
...
*   - **3/30**
    - Synthetic Control
    - identification, estimation and statistical inference, interactive FEs, **problem set 6 is posted on 3/30**
    -   - @abadie2010synthetic
...
*   - **4/8 4/13**
    - Mediation Effects
    - natural direct and indirect effects, controlled direct and indirect effects **problem set 7 is posted on 4/8**, **observational replication is due on 4/13**
