...
*   - **3/4 3/6**
    ...
    - Local Average Treatment EffectsIV estimator, one-/two-sided non-compliance, 2SLS, variance estimation
...
*   - **3/25 3/27**
    ...
    - two-period DID, pre-trends, event study, conditional DID, continuous treatment DID, TWFE bias with multiple events, event-by-event estimation
