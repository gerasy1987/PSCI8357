...
*   - **3/23 3/25**
    ...
    - conditional DID, continuous treatment DID, event-by-event estimation, **problem set 5 is posted on 3/23**
    -   - @angrist2009mostly [Ch. 5.2]
        - @bertrand2004much
...
*   - **4/6**
    - Synthetic Control
    - identification, estimation and statistical inference, interactive FEs, **problem set 6 is posted on 4/6**
    -   - @abadie2010synthetic
...
*   - **4/15 4/20**
    - Mediation Effects
    - natural direct and indirect effects, controlled direct and indirect effects, **problem set 7 is posted on 4/15**, **observational replication is due on 4/15**
