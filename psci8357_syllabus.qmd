...
*   - **3/20, 3/25**
    ...
    - two-period DID, pre-trends, event study, conditional DID, triple differences, continuous treatment DID, TWFE bias with multiple events, event-by-event estimation, shift-share DID (?)
...
The course is heavily based on the materials prepared for previous itteration of Statistics for Political Research III taught by [Bradley Smith](https://bradleycarlsmith.com/) at Vanderbilt. In addition some weeks draw on materials from similar classes taught by [Cyrus Samii](https://cyrussamii.com/) at NYU and [Naoki Egami](https://naokiegami.com/) at Columbia.
