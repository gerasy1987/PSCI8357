...
*   - **2/25 3/2 3/4**
    - Matching
    - distance metrics, exact matching, nearest neighbor matching, propensity score matching, balancing property, sensitivity analysis, weighting, doubly robust estimators, **problem set 3 is posted on 2/25**, **experimental replication is due on 3/4**
...
*   - **3/16 3/18**
    ...
    - Local Average Treatment Effects, IV estimator, one-/two-sided non-compliance, 2SLS estimator and its bias, **problem set 4 is posted on 3/18**
