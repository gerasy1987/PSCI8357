...
- The power, i.e. $\Pr\left(\text{reject } \mu_1 - \mu_0 = 0 | \mu_1 - \mu_0 = \tau \right)$ is then given by:
...
- [Note]{.note} Use standardized effect sizes to avoid ["power fallacy"]{.highlight}! 
  ...
  - [Statistical power]{.highlight}  is the probability of correctly rejecting the null hypothesis when it is false.
  ...
  - **Optimal design considerations**:
    - Balance treatment and control groups ($p \approx 0.5$)
