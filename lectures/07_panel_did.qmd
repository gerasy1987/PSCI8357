...
- @rambachan2023more propose to [bound the bias term with pre-trend differences]{.highlight}:
  ...
  $$
  \begin{align*}
  &\mathbb{E}[Y_{i1} (0) - Y_{i0} (0) \mid T_i = 1] - \mathbb{E}[Y_{i1} (0) - Y_{i0} (0) \mid G_i = 0] \\
  &\quad = \phi \left( \mathbb{E}[Y_{i0} (0) - Y_{i,-1} (0) \mid G_i = 1] - \mathbb{E}[Y_{i0} (0) - Y_{i,-1} (0) \mid G_i = 0] \right),
  \end{align*}
  $$
