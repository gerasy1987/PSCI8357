...
\begin{align*}
\hat\tau &= \E[Y_i \given T_i = 1]-\E[Y_i \given T_i = 0] \\
    &= \underbrace{\E[Y_{i} (1) - Y_{i} (0) \given T_i = 1]}_{\tau_{ATT}} +\underbrace{\E[Y_{i} (1) \given T_i=1]-\E[Y_{i} (1) \given T_i=0]}_{\text{Selection bias wrt $Y_i(1)$}}
\end{align*}
$$
...
$$
E[Y_{i} (1) | T_i = 1, X_i = x] - E[Y_{i} (0) | T_i = 1, X_i = x] = \tau_{CATE} (x)
$$
