...
$Y_{i} (t)$: Value of the outcome that *would be* realized if unit $i$ received the treatment $d$, where $d = 0$ or $1$
...
which τATE can be identified from observed information
