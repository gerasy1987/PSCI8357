...
- If $\tau_i$ was **constant** over $X_i$, the precision weighting _could_ be good from an efficiency standpoint. But this is probably irrelevant.
...
- Regression works for estimating average treatment effect or its best linear approximation 
