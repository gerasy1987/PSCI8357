...
![](../_images/matching_numberline_before.png){.fragment .fade-out data-fragment-index="1" fig-align="center" width=80%}

![](../_images/matching_numberline.png){.fragment .fade-in data-fragment-index="1" fig-align="center" width=80%}
...
&= \sqrt{\begin{pmatrix} -5 & -5 \end{pmatrix} \begin{pmatrix} 1.04 & -0.21 \\ -0.21 & 1.04 \end{pmatrix} \begin{pmatrix} -5 \\ -5 \end{pmatrix}} = 6.45 \\[6pt]
...
- Mahalanobis and other distance metrics measure [geometric similarity]{.highlight} in $\mathbf{X}$-space -- but they break down in high dimensions (curse of dimensionality)
...
parameters) to different values and seeing what the implied true $\tau$ would be.
